...
## ----figurename2, echo=FALSE, fig.cap="*Figure 2: Comparison of the LOCF and LME model to predict systolic blood pressure at a landmark age for an individual with 8 repeat measures.*"----
knitr::include_graphics("../vignettes/landmarking_lme_model.png")

## ----figurename3, echo=FALSE, fig.cap=""--------------------------------------
